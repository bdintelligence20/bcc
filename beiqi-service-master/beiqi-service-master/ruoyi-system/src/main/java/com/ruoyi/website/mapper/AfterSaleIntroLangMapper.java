 ...
 * @date 2022-06-10
 */
public interface AfterSaleIntroLangMapper 
{
    /**
     * 查询售后简介列多语言
     * 
    ...
    public int deleteAfterSaleIntroLangByIds(@Param("list") List<Long> list);

    void batchInsert(@Param("list") List<AfterSaleIntroLang> list);

    void deleteByIntroIds(@Param("list") List<Long> list);
}
