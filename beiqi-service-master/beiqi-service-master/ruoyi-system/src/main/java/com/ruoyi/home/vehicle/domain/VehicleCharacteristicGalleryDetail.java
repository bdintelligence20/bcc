 ...
 */
@Data
@TableName("vehicle_characteristic_gallery_detail")
@ApiModel(value = "VehicleCharacteristicGalleryDetail", description = "车型特性名称（相册）")
@Validated
public class VehicleCharacteristicGalleryDetail {
    ...
    @Valid
    private List<VehicleCharacteristicGalleryDetailLang> langs;
}
