...
public class MimeTypeUtils
{
    ...
    public static final String IMAGE_J2K = "image/j2k";

    public static final String IMAGE_JPF = "image/jpf";

    public static final String IMAGE_JPX = "image/jpx";

    public static final String IMAGE_JPM = "image/jpm";

    public static final String IMAGE_MJ2 = "image/mj2";
    ...
    public static final String[] IMAGE_EXTENSION = { "bmp", "gif", "jpg", "jpeg", "png", "webp", "avif", "jp2", "j2k", "jpf", "jpx", "jpm", "mj2", "heic", "heif"};

    public static final String[] FLASH_EXTENSION = { "swf", "flv" };

    public static final String[] MEDIA_EXTENSION = { "swf", "flv", "mp3", "wav", "wma", "wmv", "mid", "avi", "mpg",
            "asf", "rm", "rmvb","mp4","webm" };

    public static final String[] DEFAULT_ALLOWED_EXTENSION = {
            // 图片
            "bmp", "gif", "jpg", "jpeg", "png","webp", "avif", "jp2", "j2k", "jpf", "jpx", "jpm", "mj2", "heic", "heif",
