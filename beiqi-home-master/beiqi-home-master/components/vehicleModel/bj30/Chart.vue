...
export default {
  ...
  data() {
    return {
      ...
      beforeIndex: 0,
      colorList: [
        { value: 37.5, name: '绿', itemStyle: { color: '#96b8a6' } },      // 颜色1
        { value: 1, name: 'spacing', itemStyle: { color: 'rgba(0,0,0,0)' } }, // 虚拟数据项，值为零
        { value: 5, name: '白', itemStyle: { color: '#fff' } },       // 颜色7
        { value: 1, name: 'spacing', itemStyle: { color: 'rgba(0,0,0,0)' } }, // 虚拟数据项，值为零
        { value: 5, name: '哑光灰', itemStyle: { color: '#808080' } },       // 颜色6
        { value: 1, name: 'spacing', itemStyle: { color: 'rgba(0,0,0,0)' } }, // 虚拟数据项，值为零
        { value: 5, name: '天蓝', itemStyle: { color: '#225F78' } },       // 颜色5
        { value: 1, name: 'spacing', itemStyle: { color: 'rgba(0,0,0,0)' } }, // 虚拟数据项，值为零
        {value: 5,name: '黑',itemStyle: {color: '#000000'}},              // 颜色4
        { value: 1, name: 'spacing', itemStyle: { color: 'rgba(0,0,0,0)' } }, // 虚拟数据项，值为零
        { value: 5, name: '浅蓝', itemStyle: { color: '#a9bacc' } },       // 颜色3
        { value: 1, name: 'spacing', itemStyle: { color: 'rgba(0,0,0,0)' } }, // 虚拟数据项，值为零
        {value: 5,name: '灰',itemStyle: {color: '#808080'}},              // 颜色2
        { value: 1, name: 'spacing', itemStyle: { color: 'rgba(0,0,0,0)' } }, // 虚拟数据项，值为零
      ],
      colorList_2: [
        {value: 37.5,name: '绿',itemStyle: {color: '#96b8a6'}},      // 颜色1
  ...
  methods: {
    ...
    getRotate(e, index) {
      ...
      ;(a.option.series[index].data[a.beforeIndex].value = a.option.series[index].data[e.dataIndex].value), (a.option.series[index].data[e.dataIndex].value = l)

      if (index != 1) {
        this.getRotate(e, '1')
      }

      ;(a.beforeIndex = e.dataIndex), (a.indexIndex = a.beforeIndex), (a.updatStartAngle = a.option.series[index].startAngle)
