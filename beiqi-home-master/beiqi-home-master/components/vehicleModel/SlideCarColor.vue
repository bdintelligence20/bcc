 ...
 * @LastEditTime: 2023-09-20 23:06:44
-->
<template>
...
export default {
  ...
  data() {
    return {
      ...
      optionColor: null,
      colors: [require('~/assets/image/vehicleModel/new_x7/car_02.png'), require('~/assets/image/vehicleModel/new_x7/car_04.png'), require('~/assets/image/vehicleModel/new_x7/car_01.png'), require('~/assets/image/vehicleModel/new_x7/car_05.png'), require('~/assets/image/vehicleModel/new_x7/car_03.png'), require('~/assets/image/vehicleModel/new_x7/car_06.png'), require('~/assets/image/vehicleModel/new_x7/car_07.png'),require('~/assets/image/vehicleModel/new_x7/car_08.png'),require('~/assets/image/vehicleModel/new_x7/car_09.png')],
    }
  },
  mounted() {
