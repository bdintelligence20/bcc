<template>
  <div v-show="isVisible">
    ...
    <div class="max-1680">
      ...
      <!--      面包屑-->
      <DistributorCenter-breadcumb :link-url="linkUrl" :title="$t('distributor.video')"/>
...
export default {
  ...
  methods: {
    ...
    getmaterialList() {
      ...
      this.$api.distributor.materialList(params)
        .then(res => {
          if (res.code == 200) {
    ...
    changeType(e) {
      ...
      this.selectTableData = e ? this.tableData.filter(item => {
