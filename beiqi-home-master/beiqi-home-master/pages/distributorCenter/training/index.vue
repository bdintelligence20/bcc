<template>
  <div v-show="isVisible">
    ...
    <div class="max-1680">
      <!--      面包屑-->
      <DistributorCenter-breadcumb :link-url="linkUrl" :title="$t('distributor.training')" />
      ...
      <div v-if="selectTableData.length > 0" :class="{ 'card-list-ar': langAr }" class="card-list">
        <distributorCenterCardListItem v-for="item in selectTableData" :key="item.materialId" :item="item" class="training-card-item" @openPreview="openPreview" @closePreview="closePreview" @handleDownload="handleDownload" />
      </div>
