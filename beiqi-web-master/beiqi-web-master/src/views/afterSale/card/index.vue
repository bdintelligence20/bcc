        ...
        <el-row :gutter="40">
          <el-col :span="7">
            ...
            <el-form-item label="标题描述（英语）" prop="titleDescribeEn">
              <el-input
                type="textarea"
                v-model="form.titleDescribeEn"
                placeholder="请输入标题描述（英语）"
              />
            </el-form-item>
            <el-form-item label="图片标题（英语）" prop="subTitleEn">
              <el-input
                v-model="form.subTitleEn"
                placeholder="请输入图片标题（英语）"
              />
            </el-form-item>
            <el-form-item label="图片描述（英语）" prop="subTitleDescribeEn">
              <el-input
                type="textarea"
                v-model="form.subTitleDescribeEn"
                placeholder="请输入图片描述（英语）"
                maxlength="200"
                show-word-limit
              />
            </el-form-item>
          ...
          <el-col :span="7">
            <el-form-item label="标题（西班牙语）" prop="titleEs">
              <el-input
                ...
                placeholder="请输入标题（西班牙语）"
              />
            </el-form-item>
            <el-form-item label="标题描述（西班牙语）" prop="titleDescribeEs">
              <el-input
                type="textarea"
                v-model="form.titleDescribeEs"
                placeholder="请输入标题描述（西班牙语）"
              />
            </el-form-item>
            <el-form-item label="图片标题（西班牙语）" prop="subTitleEs">
              <el-input
                v-model="form.subTitleEs"
                placeholder="请输入图片标题（西班牙语）"
              />
            </el-form-item>
            <el-form-item
              label="图片描述（西班牙语）"
              prop="subTitleDescribeEs"
            >
              <el-input
                type="textarea"
                v-model="form.subTitleDescribeEs"
                placeholder="请输入图片描述（西班牙语）"
                maxlength="200"
                show-word-limit
              />
            </el-form-item>
          ...
          <el-col :span="7">
            <el-form-item label="标题（阿拉伯语）" prop="titleAr">
              <el-input
                ...
                placeholder="请输入标题（阿拉伯语）"
              />
            </el-form-item>
            <el-form-item label="标题描述（阿拉伯语）" prop="titleDescribeAr">
              <el-input
                type="textarea"
                v-model="form.titleDescribeAr"
                placeholder="请输入标题描述（阿拉伯语）"
              />
            </el-form-item>
            <el-form-item label="图片标题（阿拉伯语）" prop="subTitleAr">
              <el-input
                v-model="form.subTitleAr"
                placeholder="请输入图片标题（阿拉伯语）"
              />
            </el-form-item>
            <el-form-item
              label="图片描述（阿拉伯语）"
              prop="subTitleDescribeAr"
            >
              <el-input
                type="textarea"
                v-model="form.subTitleDescribeAr"
                placeholder="请输入图片描述（阿拉伯语）"
                maxlength="200"
                show-word-limit
              />
            </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      const ids = row.id || this.ids;
      this.$modal
        .confirm('是否确认删除card编号为"' + ids + '"的数据项?', "警告", {
